...
(async () => {
    ...
    // 使用 file:// 載入本機 HTML
    const absolutePath = path.resolve(__dirname, '..', 'presentation_v5.2.0', 'index.html');
    ...
    const outputFilePath = path.join(__dirname, '..', 'presentation_v5.2.0', 'Snake.io_競技場_提案簡報_v5.2.0.pptx');
