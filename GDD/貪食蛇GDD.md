...
```text
+--------------------------------------------------------------+
| [頭像] 玩家姓名 (Lv.12)  | 金幣: 15,200G  鑽石: 120◆  能量: 30/30⚡ |
|--------------------------+-----------------------------------|
|  成長之路:               |         << 選擇遊戲模式 >>        |
|  Lv.15 [████████░░] 85%  |                                   |
|                          |   +----------+ +----------+ +---+ |
...
|       ( No.2 )        |  總擊殺次數: 5 次                    |
|                       |--------------------------------------|
|      發育評級:        |  金幣獎勵: 2,800G + 50G(擊殺)        |
|      +--------+       |            = 2,850 G                 |
|      |   SS   |       |  熟練度: 300 + 30(評級) + 10(擊殺)   |
|      +--------+       |          = 340 XP                    |
|                       |  成長之路: Lv.15 [█████████░░] +340  |
|--------------------------------------------------------------|
|                         [ 返回大廳 ]                         |
...
* **金幣獎勵**：展示本局獲得的總金幣數量（評級固定金幣 + 擊殺額外金幣）。
* **熟練度獎勵**：展示本局獲得的總熟練度點數（對應門票基礎熟練度 + 評級額外熟練度 + 擊殺額外熟練度）。
...
* **岩石區**：地圖中隨機分布無法穿透的 2D 岩石（碰撞規則詳見 5.1），撞擊不致死，觸發回彈並扣減 50% 當前長度。
