...
| 攻擊方 | 受擊方 | 攻擊方狀態 | 受擊方狀態 | 攻擊方死亡 | 受擊方死亡 | 物理演出與碰撞說明 |
| :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| 頭 | 身 | `未衝刺` | `未衝刺` | O | X | 攻擊方蛇隻瞬間碎裂死亡，原地生成殘骸。 |
| 頭 | 身 | `衝刺` | `未衝刺` | X | X | **受擊方被截斷**：受擊方從撞擊點被截斷，被截斷的部分變成殘骸。 |
| 頭 | 身 | `衝刺` | `衝刺` | X | X | 雙方觸發物理回彈判定，不致死，亦不觸發截斷。 |
| 頭 | 頭 | `未衝刺` | `未衝刺` | O | O | 雙方頭部碰撞，雙方皆碎裂死亡，原地生成殘骸。 |
| 頭 | 頭 | `衝刺` | `未衝刺` | X | O | 攻擊方獲勝，受擊方判定死亡，整個碎裂變為殘骸（無視長度）。 |
| 頭 | 頭 | `衝刺` | `衝刺` | X | X | 雙方皆在衝刺時頭對頭碰撞，觸發物理回彈，不扣除長度。 |
| 頭 | 岩石或邊界 | `-` | `-` | X | `-` | 不致死。蛇身發光閃爍並物理回彈，扣除 50% 當前個人長度積分。 |
