...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 輸出 | B | C | B | B | B |
| 名稱 | ID | Name | StepCount | CompletionRule | OverrideGluttony |
| 資料型態 | int | string | int | string | bool |
| 企劃名 | 編號 | 關卡名稱 | 圖卡步驟數 | 完成條件 | 教學覆寫暴食 |
...
| :--- | :--- | :--- | :--- | :--- |
| 輸出 | B | B | B | B |
| 名稱 | ID | LevelID | Order | TextKey |
| 資料型態 | int | int | int | string |
| 企劃名 | 編號 | 教學關卡編號 | 顯示順序 | 文字 Key |
