...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 輸出 | B |  |  | B | B |
| 名稱 | ID |  |  | StartValue | MaxValue |
| 資料型態 | int |  |  | int | int |
| 企劃名 | 編號 | 被動技名稱 | 被動技描述 | Lv0 參數 | Lv40 參數 |
|  | 1 | 磁吸半徑 | 磁吸半徑永久強化（0.1 px） | 1000 | 2000 |
|  | 2 | 巨大蘑菇跑速 | 巨大蘑菇跑速強化（百分比） | -25 | 15 |
|  | 3 | 幸運糖倍率 | 幸運糖倍率強化（萬分比） | 30000 | 70000 |
|  | 4 | 鷹眼視野 | 鷹眼視野強化（萬分比） | 13500 | 17500 |
|  | 5 | 磁鐵時長 | 磁鐵時長強化（ms） | 10000 | 20000 |
|  | 6 | 巨大蘑菇時長 | 巨大蘑菇時長強化（ms） | 10000 | 20000 |
|  | 7 | 幸運糖時長 | 幸運糖時長強化（ms） | 10000 | 20000 |
|  | 8 | 鷹眼時長 | 鷹眼時長強化（ms） | 10000 | 20000 |
|  | 9 | 岩石抗性 | 岩石扣長減免（萬分比） | -5000 | -1000 |
|  | 10 | 河流抗性 | 河流減速減免（百分比） | -50 | -10 |
