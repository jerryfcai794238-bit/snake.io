...
graph TD
    ...
    J -->|否| I
    J -->|是| K{隊伍人數是否達 2 人}
    K -->|否，僅 1 人| L[開始按鈕灰階且不可用]
    K -->|是，2 至 4 人| M[隊長開始配對]
    M --> N{隊伍是否滿 4 人}
    N -->|未滿 4 人| O[友方空缺由其他玩家或電腦補足]
    N -->|已滿 4 人| P[原隊伍 4 人進入同一陣營]
    O --> Q[進入陣營對抗對局]
    P --> Q
    Q --> R[對局結束]
    R --> S[原好友隊伍返回自己的隊伍大廳]
    R --> T[補位玩家返回各自隊伍大廳或個人流程]
```
...
* **開始配對條件**：隊長僅能在隊伍人數達 `2 ~ 4` 人，且所有非隊長成員均已準備完成時發起配對；隊伍僅 `1` 人時不可開始，開始按鈕維持灰階不可用狀態。
